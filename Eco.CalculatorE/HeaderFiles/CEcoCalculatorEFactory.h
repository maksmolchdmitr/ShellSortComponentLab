...
#ifndef __C_ECO_CALCULATOR_E_FACTORY_H__
#define __C_ECO_CALCULATOR_E_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoCalculatorEFactory {
...
#endif /* __C_ECO_CALCULATOR_E_FACTORY_H__ */
