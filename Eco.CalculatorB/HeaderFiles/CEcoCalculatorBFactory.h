...
#ifndef __C_ECO_CALCULATOR_B_FACTORY_H__
#define __C_ECO_CALCULATOR_B_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoCalculatorBFactory {
...
#endif /* __C_ECO_CALCULATOR_B_FACTORY_H__ */
