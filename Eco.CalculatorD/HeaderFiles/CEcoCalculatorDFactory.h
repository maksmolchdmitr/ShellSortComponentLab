...
#ifndef __C_ECO_CALCULATOR_D_FACTORY_H__
#define __C_ECO_CALCULATOR_D_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoCalculatorDFactory {
...
#endif /* __C_ECO_CALCULATOR_D_FACTORY_H__ */
