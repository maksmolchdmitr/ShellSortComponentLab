...
static const UGUID IID_IEcoLab1 = {0x01, 0x10, 0x27, 0x7F, 0xC0, 0x0C, 0x35, 0x62, 0x40, 0x96, 0xAF, 0xCF, 0xC1, 0x25,
                                   0xB9, 0x4E, 0xEC, 0x90};
...
typedef struct IEcoLab1VTbl {
    ...
    /* IEcoLab1 */
    int16_t (ECOCALLMETHOD *ShellSortShellStep)(/* in */ struct IEcoLab1 *me, /* in */ void *base, size_t number, size_t width, int (*cmp)(const void *, const void *));
