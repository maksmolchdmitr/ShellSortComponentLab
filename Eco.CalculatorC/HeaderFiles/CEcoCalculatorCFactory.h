...
#ifndef __C_ECO_CALCULATOR_C_FACTORY_H__
#define __C_ECO_CALCULATOR_C_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoCalculatorCFactory {
...
#endif /* __C_ECO_CALCULATOR_C_FACTORY_H__ */
