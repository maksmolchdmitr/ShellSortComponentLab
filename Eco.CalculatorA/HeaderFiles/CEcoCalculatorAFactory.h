...
#ifndef __C_ECO_CALCULATOR_1_FACTORY_H__
#define __C_ECO_CALCULATOR_1_FACTORY_H__

#include "IEcoSystem1.h"

typedef struct CEcoCalculatorAFactory {
...
#endif /* __C_ECO_CALCULATOR_1_FACTORY_H__ */
